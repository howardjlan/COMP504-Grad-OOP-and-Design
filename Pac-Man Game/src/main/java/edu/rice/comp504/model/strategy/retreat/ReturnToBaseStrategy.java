package edu.rice.comp504.model.strategy.retreat;
...
public class ReturnToBaseStrategy implements IReturnToBaseStrategy {
    private static IUpdateStrategy singleton;

    /**
     * Make a return to base strategy.  There is only one (singleton).
     * @return A return to base strategy
     */
    public static IUpdateStrategy makeStrategy() {
        if (singleton == null) {
            singleton = new ReturnToBaseStrategy();
        }
