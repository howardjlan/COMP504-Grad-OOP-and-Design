...
/**
 * The aggressive chase strategy causes the ghost to choose pacman directly.
 */
public class AggressiveChaseStrategy implements IChaseStrategy {
    private static IUpdateStrategy singleton;

    /**
     * Make a aggressive strategy.  There is only one (singleton).
     * @return A aggressive strategy
     */
    public static IUpdateStrategy makeStrategy() {
        if (singleton == null) {
            singleton = new AggressiveChaseStrategy();
        }
